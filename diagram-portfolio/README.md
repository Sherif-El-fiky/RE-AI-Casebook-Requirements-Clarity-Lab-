...
Each subfolder has its own README explaining the notation choices behind that diagram and, where relevant, where I'd push back or dig deeper if this were a real project — the same way I'd annotate a diagram for a review, not a tutorial writing style.
